...
Search for imports of changed modules across test files:

```bash
rg "from lightspeed_agentic\.<changed_module> import" tests/
rg "import lightspeed_agentic\.<changed_module>" tests/
```
