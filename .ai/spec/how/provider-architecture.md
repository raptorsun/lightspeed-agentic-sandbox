...
| `src/lightspeed_agentic/providers/claude.py` | Removed. [PLANNED: OLS-3473] |
...
- **~~Claude skills layout:~~** Removed. [PLANNED: OLS-3473]
...
- **Containerfile:** Multi-stage build — builder installs hashed requirements into target site-packages; runtime copies site-packages, app `src`, sets user `agent`, `catatonit` entrypoint, Uvicorn CMD on port 8080. [PLANNED: OLS-3473] Claude Code npm install and `node_modules` copy removed.
